...
class Oto < Phuongtien
    ...
    def hienthi
        puts "Oto Mã :#{id114} Hàng sản xuất: #{hangsanxuat114} Năm sản xuất: #{namsanxuat114} Dòng xe: #{dongxe114} Giá bán: #{giaban114} Biến số: #{bienso114} Màu xe: #{mauxe114} Số chỗ ngồi: #{sochongoi114} Kiểu động cơ: #{kieudongco1141} Nhiên liêu: #{nhienlieu114}  Số túi khí: #{sotuikhi114} Ngày đăng kiếm: #{ngaydangkiem114}"
    end
end
